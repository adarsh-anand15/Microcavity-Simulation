...
clc;
Microcavity_Reflectivity(handles);
...
function LambdaC_Callback(hObject, eventdata, handles)
% hObject    handle to LambdaC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of LambdaC as text
%        str2double(get(hObject,'String')) returns contents of LambdaC as a double


% --- Executes during object creation, after setting all properties.
function LambdaC_CreateFcn(hObject, eventdata, handles)
% hObject    handle to LambdaC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
choice=get(handles.choicemenu,'Value');

switch choice
    case 1
        Microcavity_Reflectivity(handles);
    case 2
        field_profile(handles);
...
function thetaEi_Callback(hObject, eventdata, handles)
% hObject    handle to thetaEi (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of thetaEi as text
%        str2double(get(hObject,'String')) returns contents of thetaEi as a double


% --- Executes during object creation, after setting all properties.
function thetaEi_CreateFcn(hObject, eventdata, handles)
% hObject    handle to thetaEi (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
